...
import com.sendbird.live.uikit.sample.adapter.LiveEventListAdapter
import com.sendbird.live.uikit.sample.databinding.FragmentLiveEventListBinding
import com.sendbird.live.uikit.sample.util.INTENT_KEY_CREATED_LIVE_EVENT_ID
...
import com.sendbird.live.uikit.sample.util.areAnyPermissionsGranted
import com.sendbird.live.uikit.sample.util.showAlertDialog
...
import com.sendbird.live.uikit.sample.view.CreateLiveEventActivity
import com.sendbird.live.uikit.sample.view.LiveEventForParticipantActivity
import com.sendbird.live.uikit.sample.view.LiveEventSetUpActivity
...
class LiveEventListFragment :
    ...
    private fun enterAsHost(liveEvent: LiveEvent) {
        ...
        val intent = Intent(requireContext(), com.sendbird.live.uikit.sample.view.LiveEventSetUpActivity::class.java)
