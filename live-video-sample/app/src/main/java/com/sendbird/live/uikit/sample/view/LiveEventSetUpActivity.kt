...
import com.sendbird.live.uikit.sample.model.toAudioDevice
import com.sendbird.live.uikit.sample.util.INTENT_KEY_LIVE_EVENT_ID
import com.sendbird.live.uikit.sample.util.cameraNameResId
import com.sendbird.live.uikit.sample.util.getAvailableLiveAudioDevice
import com.sendbird.live.uikit.sample.util.getAvailableVideoDevices
...
class LiveEventSetUpActivity : AppCompatActivity() {
    ...
    private fun enterTheLiveEvent() {
        ...
        liveEvent.enterAsHost(MediaOptions(videoDevice = currentVideoDevice, audioDevice = currentAudioDevice?.toAudioDevice())) { e ->
            ...
            val intent = Intent(this, com.sendbird.live.uikit.sample.view.LiveEventForHostActivity::class.java)
